...
> The script will also fail spectacularly if you specify a column that doesn't exist in any of the files.  the log file `validation_results.json` will be appended to.
